        ...
        ?>
          ...
          <div class=' my-1'>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        <p class="mb-2">Below is a total of the amount you'll be paying for this project and the <b class="text-danger">70%</b> you will be paying now</p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <input type="hidden" name="percent" id="percent" value="70%">
                    ...
                    <div class="col p-3" style="border:2px solid black">
                        ...
                        <p>Number of Marketers Engaged : <b><?php echo $data["req_no_of_marketers"] ?></b></p>
                        ...
                        <hr>
                        <p>Amount left to Pay : <b><?php $percentage = pow(0.7,1); $now = $total * $percentage; ?>&#8358;<?php echo number_format($now) ?>.00</b></p>
          ...
          <button type="submit" id="complete_pay" name="complete_pay" class="btn col-12 btn-success my-2">Pay</button>
