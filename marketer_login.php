...
?>
  <form action="process/marketer_login.php" method="post">
...
<footer class="container position-fixed bottom-0">
  ...
  <div class="col">
  <span id="donthaveanaccount">Don't have an account? </span><a href="marketer_registration.php" id="registerhere" style="text-decoration: none;"><span>Register here</span></a>
