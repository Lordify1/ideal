...
<div class="accordion mt-3" id="accordionExample">
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      ...
      <form action="process/process_faqs.php" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
          ...
          <div>
            <label for="">FAQ_text</label>
            <textarea name="" id="" cols="30" rows="10" class="form-control my-2"></textarea>
          </div>
          <div class="mb-3">
            <button type="submit" name="topic_btn" class="btn btn-primary">Add FAQ</button>
          </div>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
      <div class="accordion-body">
     <iframe src="../faq.php" frameborder="0" width="100%" height="200vh">FAQ</iframe>
      </div>
    </div>
  </div>
  </div>
